...
META_DECKS = {
    "alakazam": [5, 5, 13, 19, 19, 19, 19, 66, 66, 140, 305, 305, 305, 343, 741, 741, 741,
                 741, 742, 742, 742, 742, 743, 743, 743, 743, 1079, 1079, 1079, 1081, 1081,
                 1081, 1081, 1086, 1086, 1086, 1086, 1097, 1129, 1152, 1152, 1152, 1152,
                 1182, 1182, 1182, 1184, 1197, 1197, 1197, 1225, 1225, 1225, 1225, 1231,
                 1231, 1231, 1231, 1266, 1266],
    "grimmsnarl": [7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 104, 104, 112, 112, 112, 112, 646, 646,
                   646, 646, 647, 647, 647, 648, 648, 648, 860, 860, 1079, 1079, 1079, 1080,
                   1086, 1086, 1086, 1086, 1097, 1097, 1097, 1122, 1137, 1152, 1152, 1152,
                   1152, 1182, 1182, 1219, 1219, 1219, 1219, 1227, 1227, 1227, 1227, 1231,
                   1259, 1259, 1259, 1259],
    "kangaskhan": [1, 1, 1, 1, 1, 1, 1, 1, 1, 3, 3, 4, 4, 5, 5, 6, 6, 63, 63, 96, 96, 96,
                   108, 140, 184, 184, 272, 756, 756, 756, 756, 1071, 1071, 1071, 1088, 1097,
                   1097, 1098, 1098, 1116, 1116, 1116, 1116, 1121, 1121, 1121, 1121, 1182,
                   1182, 1197, 1198, 1198, 1198, 1198, 1205, 1205, 1250, 1250, 1250, 1250],
    "mewtwo": [1, 1, 1, 1, 1, 1, 1, 1, 1, 15, 15, 15, 15, 400, 400, 400, 400, 401, 401,
               401, 401, 414, 414, 431, 431, 434, 434, 1094, 1094, 1094, 1121, 1121, 1122,
               1134, 1134, 1134, 1134, 1152, 1152, 1152, 1159, 1182, 1182, 1216, 1216, 1216,
               1216, 1217, 1217, 1217, 1220, 1220, 1220, 1220, 1227, 1227, 1227, 1257, 1257,
               1257],
    "lucario": [673, 673, 674, 674, 675, 675, 676, 676, 676, 677, 677, 677, 678, 678, 678,
                678, 1102, 1102, 1102, 1102, 1123, 1123, 1141, 1141, 1141, 1141, 1142, 1142,
                1142, 1142, 1152, 1152, 1152, 1152, 1159, 1182, 1182, 1192, 1192, 1192, 1192,
                1227, 1227, 1227, 1227, 1252, 1252, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6],
    "archaludon": [8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 57, 169, 169, 169, 169, 190, 190, 190,
                   190, 666, 666, 666, 666, 1097, 1097, 1097, 1121, 1121, 1121, 1121, 1122,
                   1122, 1122, 1122, 1147, 1147, 1147, 1147, 1152, 1152, 1152, 1152, 1159,
                   1182, 1182, 1182, 1182, 1185, 1185, 1185, 1185, 1227, 1227, 1227, 1227,
                   1244, 1244, 1244, 1244],
    "dragapult": [119, 119, 119, 119, 120, 120, 120, 120, 121, 121, 121, 235, 235, 140, 184,
                  1071, 2, 2, 2, 2, 5, 5, 5, 5, 1086, 1086, 1086, 1086, 1120, 1120, 1120,
                  1120, 1121, 1121, 1121, 1121, 1198, 1198, 1198, 1198, 1227, 1227, 1227,
                  1227, 1152, 1152, 1152, 1182, 1182, 1182, 1079, 1079, 1097, 1097, 1210,
                  1210, 1256, 1256, 1080, 1156],
    "froslass": [3, 3, 3, 3, 3, 3, 3, 3, 3, 11, 12, 17, 860, 860, 860, 860, 861, 861, 861,
                 1030, 1030, 1030, 1030, 1031, 1031, 1031, 1086, 1086, 1086, 1086, 1097,
                 1119, 1119, 1119, 1119, 1122, 1122, 1122, 1123, 1123, 1145, 1145, 1182,
                 1182, 1189, 1189, 1189, 1189, 1211, 1225, 1225, 1227, 1227, 1227, 1227,
                 1229, 1229, 1229, 1252, 1252],
}
# rough field-share weights for tie-breaking archetype matches
META_WEIGHT = {"alakazam": 5, "kangaskhan": 4, "grimmsnarl": 3, "mewtwo": 3,
               "lucario": 2, "archaludon": 2, "dragapult": 2, "froslass": 1}
...
def _search_move(obs, me, opp_model, deadline, rng, n_worlds_target=4,
    ...
    # round-robin iterations across worlds until the deadline
...
def _budget(obs, sel):
    ...
    if n <= 2:
        weight *= 0.6
    return max(0.05, min(1.1, share * weight))
